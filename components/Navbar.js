					...
					<div className="py-2 flex flex-col">
						...
						<div className="py-3 flex flex-col">
							<a target="_blank" href="/download.png">
								<button
									type="button"
									className="inline-block max-w-[50%] px-6 py-3 border-2 rounded-md border-[#e5e7e9] text-[#1E90FF] font-bold text-sm leading-tight normal-case bg-white shadow-lg hover:bg-[#1E90FF] hover:text-white hover:shadow-xl focus:outline-none transition duration-300 ease-in-out transform hover:scale-105"								>
									Resume
								</button>
							</a>
						</div>
						...
						<div className="pt-40">
							<p className="uppercase tracking-widest text-[#dce0e4]">
								Let&apos;s connect
							</p>
